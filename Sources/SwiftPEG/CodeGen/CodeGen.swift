...
public class CodeGen {
    ...
    /// Returns the reduced and tagged grammar for code generation.
    ...
    func validateNamedItems() throws {
        let visitor = NamedItemVisitor { node in
            ...
            if name == "_" {
                throw CodeGenError.invalidNamedItem(
    ...
    /// An error that can be raised by `CodeGen` during grammar analysis and parser
    /// generation.

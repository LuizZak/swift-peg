...
class BindingEngine {
    ...
    fileprivate var ruleReturnAliases: [String: CommonAbstract.SwiftType]
    ...
    /// Creates an independent copy of `self` that replaces rule results with a
    /// custom mapping.
    func withCustomRuleResultMappings(
        _ ruleReturnAliases: [String: CommonAbstract.SwiftType]
    ) -> BindingEngine {
        let copy = BindingEngine(
